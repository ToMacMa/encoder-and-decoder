...
def run2(event=None):
    try:
        ...
        hid1['state'] = 'normal'
        hid1.delete(0,tk.END)
        hid1.insert(0,"An error has occured.")
        hid1['state'] = 'readonly'
    try:
        ...
        hid2['state'] = 'normal'
        hid2.delete(0,tk.END)
        hid2.insert(0,"An error has occured.")
        hid2['state'] = 'readonly'
...
button2 = tk.Button(root,font=("Arial",int(root.winfo_screenwidth()/100)),text="File encrypt and decrypt",bg="white",command=lambda:run2())
